/* @ts-self-types="./hegemony_core.d.ts" */
 ...
 * @returns {any}
 */
export function apply_mutation_wasm(state, mutation, label) {
    const ptr0 = passStringToWasm0(label, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.apply_mutation_wasm(state, mutation, ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function compute_vp_wasm(state, class_id) {
    const ret = wasm.compute_vp_wasm(state, class_id);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function create_starting_state_wasm(input) {
    const ret = wasm.create_starting_state_wasm(input);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function undo_wasm(state) {
    const ret = wasm.undo_wasm(state);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('hegemony_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
